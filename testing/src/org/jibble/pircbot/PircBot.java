...
public abstract class PircBot implements ReplyConstants, PircBotLogger {
     ...
     */
    protected void onPrivateMessage(String sender, String login, String hostname, String message) {SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_PRIVMSG, new SnipesEventParams(this,sender,hostname,message));}
     ...
     */
    protected void onNotice(String sourceNick, String sourceLogin, String sourceHostname, String target, String notice) {SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_NOTICE, new SnipesEventParams(this,sourceNick,sourceHostname,target));}
