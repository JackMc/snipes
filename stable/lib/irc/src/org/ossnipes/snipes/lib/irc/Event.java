...
public enum Event
{
	 ...
	 * exactly as the {@link #IRC_PRIVMSG} event, but I will explain it's params here. This is not handled in the
	 ...
	 * message -- The quit message specified. As with the {@link #IRC_PART} event, this parameter may be null.<BR/>
