...
public class Cleanup implements Runnable {
    ...
    public void run() {
        ...
        } catch (NoSnipesInstanceException e) { System.err.println("The bot seems to have crashed or have been shut down before the bot even had a chance to load it's \nplugins! This just means that there was nothing to end, so we didn't end it. \nJust thought you should know..."); }
