...
public abstract class PircBot implements ReplyConstants, PircBotLogger {
    ...
    protected void onConnect() {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_CONNENCT, new SnipesEventParams(this));
    }
    ...
    protected void onDisconnect() {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_DISCONNECT, new SnipesEventParams(this));
    }
    ...
    protected void onServerResponse(int code, String response) {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_SERVRESPONSE, new SnipesEventParams(this, Integer.toString(code), response));
    }
    ...
    protected void onMessage(String channel, String sender, String login, String hostname, String message) {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_CHANMSG, new SnipesEventParams(this, channel, sender, hostname, message));
    }
    ...
    protected void onPrivateMessage(String sender, String login, String hostname, String message) {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_PRIVATEMSG, new SnipesEventParams(this, sender, hostname, message));
    }
    ...
    protected void onAction(String sender, String login, String hostname, String target, String action) {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_ACTION, new SnipesEventParams(this, target, sender, hostname, action));
    }
    ...
    protected void onNotice(String sourceNick, String sourceLogin, String sourceHostname, String target, String notice) {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_NOTICE, new SnipesEventParams(this, sourceNick, sourceHostname, target, notice));
    }
    ...
    protected void onJoin(String channel, String sender, String login, String hostname) {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_NOTICE, new SnipesEventParams(this, channel, sender, hostname));
    }
    ...
    protected void onPart(String channel, String sender, String login, String hostname, String reason) {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_NOTICE, new SnipesEventParams(this, channel, sender, hostname, reason));
    }
    ...
    protected void onNickChange(String oldNick, String login, String hostname, String newNick) {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_NOTICE, new SnipesEventParams(this, oldNick, newNick, hostname));
    }
    ...
    protected void onKick(String channel, String kickerNick, String kickerLogin, String kickerHostname, String recipientNick, String reason) {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_KICK, new SnipesEventParams(this, kickerNick, recipientNick, kickerHostname,reason));
    }
    ...
    protected void onQuit(String sourceNick, String sourceLogin, String sourceHostname, String reason) {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_NOTICE, new SnipesEventParams(this, sourceNick, sourceHostname, reason));
    }
    ...
    protected void onTopic(String channel, String topic, String setBy, long date, boolean changed) {
        if (!setBy.equalsIgnoreCase(getNick()) && changed)
        {
            SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_TOPIC_CHANGED, new SnipesEventParams(this, channel, topic, setBy));
        }
    }
    ...
    protected void onMode(String channel, String sourceNick, String sourceLogin, String sourceHostname, String mode) {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_MODE, new SnipesEventParams(this, channel, sourceNick, sourceHostname, mode));
    }
    ...
    protected void onInvite(String targetNick, String sourceNick, String sourceLogin, String sourceHostname, String channel) {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_NOTICE, new SnipesEventParams(this, sourceNick, sourceHostname, channel));
    }
    ...
    protected void onIncomingChatRequest(DccChat chat) {
        SnipesBot.sendEvent(SnipesEvent.SNIPES_IRC_DCCCHAT, new SnipesEventParams(this, new Object[] {chat}));
    }
